...
public class Main {
        ...
        public static void main(String[] args) {
                try {
                        ...
                        try (BufferedWriter out = Files.newBufferedWriter(cfg.output, StandardCharsets.UTF_8)) {
                                out.write("-- Generated by Nem12ToSql.java\n-- Target table: " + cfg.table + "\n\n");
                        ...
                        System.out.println("Wrote SQL to " + cfg.output.toAbsolutePath());
                } catch (Exception e) {
        ...
        private static void flushBatch(BufferedWriter out, String table, List<Row> batch) throws IOException {
                ...
                for (int i = 0; i < batch.size(); i++) {
                        ...
                        out.write("    ('" + nmiSql + "', '" + tsStr + "', " + r.consumption.toPlainString() + ")");
                        out.write(i == batch.size() - 1 ? "\n" : ",\n");
                }
                out.write("ON CONFLICT (\"nmi\",\"timestamp\") DO UPDATE SET \"consumption\" = EXCLUDED.\"consumption\";\n\n");
        }
        ...
        private static Config parseArgs(String[] args) {
                ...
                if (c.output == null) {
                        System.err.println("Missing -o <output.sql>");
                        printHelp();
                        return null;
                }
                if (c.inputs.isEmpty()) {
        ...
        private static void printHelp() {
                System.out.println(
                        "Usage: java Nem12ToSql [options] -o <output.sql> <input1.csv> [input2.csv ...]\n" +
                                "Options:\n" +
